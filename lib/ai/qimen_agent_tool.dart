...
///
/// 提供起局排盘能力给 AI Agent
class QiMenAgentTool implements AgentTool {
  final ServiceLocator _locator;

  QiMenAgentTool([ServiceLocator? locator])
  ...
  Future<Map<String, dynamic>> execute(Map<String, dynamic> args) async {
    try {
      ...
      final panParams = ArrangePanParams(
        ju: ju,
        plateType: PlateType.ZHUAN_PAN, // Default to Zhuan Pan for now
        settings: PanSettings.defaultSettings(), // Need access to this
      );
