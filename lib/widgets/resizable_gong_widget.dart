...
class _ResizableGongWidgetState extends State<ResizableGongWidget> {
                      ...
                      child: RotatedBox(
                        ...
                        child: ColorFiltered(
                            colorFilter: ColorFilter.mode(
                                ...
                                BlendMode.srcIn),
                            child: Image.asset(
                              "packages/persistence_assets/lib/qimendunjia/assets/icons/long_yin_zhang.png",
                              width: 64,
                              height: 20,
                            )),
                      ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          image: DecorationImage(
              image: const AssetImage("packages/persistence_assets/lib/qimendunjia/assets/icons/yin_zhang.png"),
              colorFilter: ColorFilter.mode(
                  ConstResourcesMapper
            ...
            AnimatedPositioned(
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                  image: DecorationImage(
                      image:
                          AssetImage("packages/persistence_assets/lib/qimendunjia/assets/icons/chinese-red-ink-seal.png"),
                      colorFilter:
    ...
    return Container(
      ...
      child: Stack(
        ...
        children: [
          ...
          //           BlendMode.srcIn),
          //       child: Image.asset("packages/persistence_assets/lib/qimendunjia/assets/icons/mu.png")),
          // ),)
        ],
      ),
    );
  ...
  Widget _buildZhiFuStar(double width) {
    return AnimatedContainer(
        ...
        child: ColorFiltered(
            ...
            child: Image.asset(
              "packages/persistence_assets/lib/qimendunjia/assets/icons/wide-black-ink-line.png",
            )));
  }
    ...
    return AnimatedContainer(
        ...
        child: ColorFiltered(
            colorFilter: const ColorFilter.mode(
                Color.fromRGBO(176, 31, 36, .8), BlendMode.srcIn),
            child: Image.asset(
              "packages/persistence_assets/lib/qimendunjia/assets/icons/wide-black-ink-radian-line2.png",
            )));
  }
        ...
        decoration: BoxDecoration(
            ...
            image: DecorationImage(
                ...
                colorFilter: ColorFilter.mode(
                    ...
                    BlendMode.srcIn),
                image: const AssetImage("packages/persistence_assets/lib/qimendunjia/assets/icons/red-ink-background.png")),
          ...
          children: [
            ...
            Stack(
              ...
              children: [
                  ...
                  SizedBox(
                    ...
                    child: ColorFiltered(
                        colorFilter: ColorFilter.mode(
                            ...
                            BlendMode.srcIn),
                        child: Image.asset("packages/persistence_assets/lib/qimendunjia/assets/icons/red-ink-circle.png")
                        // child: Image.asset("packages/persistence_assets/lib/qimendunjia/assets/icons/thin-black-ink-circle.png")
                        // child: Image.asset("packages/persistence_assets/lib/qimendunjia/assets/icons/jia_dun_jia.png")
                        ),
                  ),
                if (isMuOrKu != null)
                  SizedBox(
                ...
                //           BlendMode.srcIn),
                //       // child: Image.asset("packages/persistence_assets/lib/qimendunjia/assets/icons/thin-black-ink-circle.png")
                //       child: Image.asset("packages/persistence_assets/lib/qimendunjia/assets/icons/jia_ru_mu.png")
                //   ),
                // ),
                if (NineYiUtils.isLiuYiJiXing(gan, gong.gongGua))
                  SizedBox(
                    ...
                    child: ColorFiltered(
                        ...
                        child: Image.asset("packages/persistence_assets/lib/qimendunjia/assets/icons/ji_xing.png")),
                  ),
                Text(gan.name,
                        ...
                        SizedBox(
                          ...
                          child: ColorFiltered(
                              colorFilter: ColorFilter.mode(
                                  ...
                                  BlendMode.srcIn),
                              child:
                                  Image.asset("packages/persistence_assets/lib/qimendunjia/assets/icons/red-ink-circle.png")
                              // child: Image.asset("packages/persistence_assets/lib/qimendunjia/assets/icons/thin-black-ink-circle.png")
                              // child: Image.asset("packages/persistence_assets/lib/qimendunjia/assets/icons/jia_dun_jia.png")
                              ),
                        ),
        ...
        children: [
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                          ...
                          image: const AssetImage(
                            "packages/persistence_assets/lib/qimendunjia/assets/icons/ji_xiong_yin_zhang.png",
                          )),
                    ),
                    child: AutoSizeText(
                      "吉",
          ...
          FutureBuilder(
            future: precacheImage(
                const AssetImage('packages/persistence_assets/lib/qimendunjia/assets/icons/xiang_yun_wen_l.png'), context),
                        ...
                        child: SizedBox(
                          ...
                          child: ColorFiltered(
                              colorFilter:
                                  ColorFilter.mode(backColor, BlendMode.srcIn),
                              child: Image.asset(
                                "packages/persistence_assets/lib/qimendunjia/assets/icons/xiang_yun_line_1.png",
                              )),
                        ))
                        ...
                        child: SizedBox.fromSize(
                          ...
                          child: ColorFiltered(
                              colorFilter:
                                  ColorFilter.mode(backColor, BlendMode.srcIn),
                              child: Image.asset(
                                "packages/persistence_assets/lib/qimendunjia/assets/icons/xiang_yun_wen_l.png",
                              )),
                        ))
                    .animate(autoPlay: true)
                    .moveX(
          ...
          FutureBuilder(
            future: precacheImage(
                const AssetImage('packages/persistence_assets/lib/qimendunjia/assets/icons/xiang_yun_wen_r.png'), context),
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.done) {
                // 图片加载完成后执行的操作
                return Positioned(
                    ...
                    child: SizedBox.fromSize(
                        ...
                        child: ColorFiltered(
                            colorFilter:
                                ColorFilter.mode(backColor, BlendMode.srcIn),
                            child: Image.asset(
                              "packages/persistence_assets/lib/qimendunjia/assets/icons/xiang_yun_wen_r.png",
                            ))),
                  ),
                )
                        .animate(
          ...
          ? BoxDecoration(
              image: DecorationImage(
                  ...
                  colorFilter: ColorFilter.mode(
                      ...
                      BlendMode.srcIn),
                  image: const AssetImage(
                      "packages/persistence_assets/lib/qimendunjia/assets/icons/thin-black-ink-circle.png")),
            )
          : null,
  ...
  Widget _buildHorseStar([Color color = Colors.black]) {
    return Lottie.asset("packages/persistence_assets/lib/qimendunjia/assets/lotties/horse_walking.json",
